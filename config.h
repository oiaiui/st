...
#include <headers/eyesoreless/eyesoreless_colors.h>
...
static const char *colorname[] = {
	...
	esrls_n_white,	// 256 cursor
	esrls_n_white,	// 257 reverse cursor
	esrls_n_black,	// 258 default background colour
	esrls_n_white,	// 259 default foreground colour
};
